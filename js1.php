...
<body>
	...
	<script>
        ...
        alert("Price/Quantity can not be 0 or less");
			...
			document.getElementById("rate").innerHTML = "Price rate is " + rate;
			rate1=parseFloat(rate);
			
		}

        function result1(quantity){
			document.getElementById("quantity").innerHTML = "Quantity is " + quantity;
			quantity1=parseInt(quantity);
		}
		console.log(rate1);
		console.log(quantity1);
		 if(!isNaN(rate1) && !isNaN(quantity1))
		 {
